        ...
        <form onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="mb-4">
            <label className="flex items-center cursor-pointer">
              <input
                ...
                className="mr-2"
              />
              <span className="text-sm font-medium text-gray-700">Es Persona Jurídica</span>
            </label>
          </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring focus:border-blue-300"
            />
            {errors.email && <p className="text-red-500">Ingrese un correo electrónico</p>}
          </div>
          <div className="mb-4">
            ...
            {errors.phone?.type === "maxLength" && (
              <p className="text-red-500">El número no debe tener más de 12 dígitos</p>
            )}
          </div>
          <div className="mb-4">
            ...
            <input
              ...
              className="mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring focus:border-blue-300"
            />
            {errors.address && <p className="text-red-500">Ingrese una dirección de residencia</p>}
          </div>
