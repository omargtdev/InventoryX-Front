		...
		<tr key={rowIndex} className="bg-white border-b-2 border-black ">
			...
			<td className="text-base text-gray-900 px-6 py-4 whitespace-nowrap">
				...
				<input
					className="w-20 text-center font-sans-montserrat border-[#3a87bb] border rounded-lg px-2  py-1"
					type="text"
					value={rowData.compra}
					onChange={(e) =>
						handleCellValueChange(rowIndex, "compra", e.target.value)
					}
					readOnly={rowData.isUnlocked ? true : false}
				/>
			</td>
			<td className="text-base  text-gray-900 px-6 py-4 whitespace-nowrap">
				S/
				<input
					className="w-16 text-center font-sans-montserrat border-[#3a87bb] border rounded-lg px-2  py-1"
					type="text"
					value={rowData.venta}
					onChange={(e) =>
						handleCellValueChange(rowIndex, "venta", e.target.value)
					}
					readOnly={rowData.isUnlocked ? true : false}
				/>
			</td>
